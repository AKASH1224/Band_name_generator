...
app.post("/submit", (req, res) => {
  ...
  //Hint: When the "Geate Name" button in index.ejs is clicked, it should hit up this route.
  //Then:
  ...
  // Send the index.ejs as a response and add the adjective and noun to the res.render
